const BINARY_MASKS = {
  ...
  GROUP_BY_8_BITS: { dec: 8, hex: 0x00FF00FF }, // 1111111100000000... in hexadecimal
...
exports.Count = input => {
  ...
  let value = input - ((input >> BINARY_MASKS.GROUP_BY_1_BIT.dec) & BINARY_MASKS.GROUP_BY_1_BIT.hex)
  value = ((value >> BINARY_MASKS.GROUP_BY_2_BITS.dec) & BINARY_MASKS.GROUP_BY_2_BITS.hex) +
    (value & BINARY_MASKS.GROUP_BY_2_BITS.hex)
  value = ((value >> BINARY_MASKS.GROUP_BY_4_BITS.dec) + value) & BINARY_MASKS.GROUP_BY_4_BITS.hex
  value = ((value >> BINARY_MASKS.GROUP_BY_8_BITS.dec) + value) & BINARY_MASKS.GROUP_BY_8_BITS.hex
  const bitCount = ((value >> BINARY_MASKS.GROUP_BY_16_BITS.dec) + value) & BINARY_MASKS.GROUP_BY_16_BITS.hex
